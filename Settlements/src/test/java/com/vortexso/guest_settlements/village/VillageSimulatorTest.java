...
class VillageSimulatorTest {
    ...
    void deterministicSimulation() {
        VillageState initial =
                village(20, 4, 30, 100.0);

        VillageDayInput input =
                input(4, 100.0, 1.0, 0.1);

        VillageState first =
                VillageSimulator.simulateDay(
                        initial,
                        input,
                        SEED,
                        PARAMETERS
    ...
    void fieldCapacityLimitsProduction() {
        VillageDayInput input =
                input(100, 100.0, 1.0, 0.0);

        assertEquals(
                100.0,
                VillageSimulator.foodProduction(
                        input,
                        PARAMETERS
                ),
                1e-9
    ...
    void additionalFarmersDoNotIncreaseProductionAfterFieldCapacity() {
        VillageDayInput fewFarmers =
                input(20, 100.0, 1.0, 0.0);

        VillageDayInput manyFarmers =
                input(1000, 100.0, 1.0, 0.0);
    ...
    void villageCanBecomeExtinct() {
        VillageState state =
                village(100, 20, 100, 0.0);

        VillageDayInput input =
                input(0, 0.0, 0.0, 1000.0);

        for (int day = 0;
             day < 100 && state.population() > 0;
             day++) {
    ...
    void populationCannotGrowBeyondHousingCapacity() {
        VillageState state =
                village(20, 4, 20, 1000.0);

        VillageDayInput input =
                input(20, 1000.0, 1.0, 0.0);
